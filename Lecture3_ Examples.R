...
cs<-apply(OmicsSomaticMutationsMatrixHotspot, 2, sum)
OmicsSomaticMutationsMatrixHotspot [, cs> 4] %>% corner
...
contingency_matrix("BRCA1", "BRCA2")
...
co.occurences %>%
  reshape2::melt(varnames = c("gene1", "gene2")) %>% head
